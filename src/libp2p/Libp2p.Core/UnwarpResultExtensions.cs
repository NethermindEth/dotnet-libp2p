...
public static class UnwrapResultExtensions
{
    public static async ValueTask OrThrow(this ValueTask<IOResult> self)
    {
        ...
        {
            throw new ChannelClosedException($"Channel closed. IOResult: {self.Result}");
        }
        ...
        {
            throw new ChannelClosedException($"Channel closed. IOResult: {result}");
        }
    }
    public static async ValueTask<ReadOnlySequence<byte>> OrThrow(this ValueTask<ReadResult> self)
    {
        ...
        {
            throw new ChannelClosedException($"Channel closed. IOResult: {self.Result.Result}");
        }
        ...
        {
            throw new ChannelClosedException($"Channel closed. IOResult: {result.Result}");
        }
        else
        {
            return result.Data;
