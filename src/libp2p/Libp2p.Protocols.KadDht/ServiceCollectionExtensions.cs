...
public static class ServiceCollectionExtensions
{
        ...
        Action<KadDhtOptions>? configureOptions = null)
    {
        ...
        // Register message sender - use LibP2pKademliaMessageSender for network operations
        services.AddSingleton<Kademlia.IKademliaMessageSender<PublicKey, DhtNode>, LibP2pKademliaMessageSender>();

        // Register main KadDht protocol with proper dependency injection
    ...
    public static ILibp2pPeerFactoryBuilder WithKadDht(this ILibp2pPeerFactoryBuilder builder)
    {
        ...
        {
            // For now, just return a successful ping response
            // In a full implementation, this could update routing table, etc.
        ...
        async Task<FindNeighboursResponse> HandleFindNeighboursRequest(FindNeighboursRequest request, ISessionContext context)
        {
            ...
            // In a full implementation, this would query the local routing table
        ...
        async Task<PutValueResponse> HandlePutValueRequest(PutValueRequest request, ISessionContext context)
        {
            try
            {
                // In a full implementation, this would delegate to the KadDhtProtocol service
                // to store the value in the local value store
        ...
        async Task<GetValueResponse> HandleGetValueRequest(GetValueRequest request, ISessionContext context)
        {
            ...
            {
                // In a full implementation, this would delegate to the KadDhtProtocol service
                // to retrieve the value from the local value store
        ...
        async Task<AddProviderResponse> HandleAddProviderRequest(AddProviderRequest request, ISessionContext context)
        {
            ...
            {
                // In a full implementation, this would delegate to the KadDhtProtocol service
                // to add the provider record to the local provider store
        ...
        async Task<GetProvidersResponse> HandleGetProvidersRequest(GetProvidersRequest request, ISessionContext context)
        {
            ...
            {
                // In a full implementation, this would delegate to the KadDhtProtocol service
                // to query the local provider store
        ...
        // Add all KadDht request-response protocols to the peer factory
