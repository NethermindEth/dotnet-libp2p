...
The docs from the application developer perspective: [quick start](./docs/README.md), [sessions](./docs/sessions.md), [discovery](./docs/discovery.md), and [pubsub](./docs/pubsub.md).
