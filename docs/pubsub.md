...
Pubsub is enabled on the standard stack with `WithPubsub()`. It adds floodsub and gossipsub protocols and provides a shared `PubsubRouter` for topic operations.
